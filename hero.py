...
class Hero():
   ...
   def accept_events(self):
       ...
       base.accept(texture_block, self.land.set_texture_block)
       base.accept(texture_brick, self.land.set_texture_brick)
       base.accept(texture_wood, self.land.set_texture_wood)
       base.accept(texture_stone, self.land.set_texture_stone)
       base.accept(texture_block_glass, self.land.set_texture_blockglass)
       base.accept(texture_green, self.land.set_texture_green)
