...
class Mapmanager():
           ...
           for line in file:
               ...
               for z in line:
                   for z0 in range(int(z)+1):
                       if z0 == 0:
                           self.set_texture_block()
                       elif z0 == 1:
                           self.set_texture_stone()
                       else:
                           self.set_texture_brick()
   ...
   def saveMap(self):
        ...
        # пдф чтобы в облако сохранялось
        with open('my_map.pdf', 'wb') as fout:
            ...
            for block in blocks:
                ...
                t = block.getTexture()
                # print(t.get_name())
                pos = (int(x), int(y), int(z), t.get_name())
   ...
   def loadMap(self):
        ...
        with open('my_map.pdf', 'rb') as fin:            
            ...
            for i in range(length):
                ...
                pos = tuple(data[0:3])
                self.texture = data[3]+".png"
                # создаём новый блок
                self.addBlock(pos)
        print("map loaded")

   def set_texture_block(self):
       self.texture = 'block.png'
       #print("block")

   def set_texture_wood(self):
       self.texture = 'wood.png'
       #print("wood")

   def set_texture_stone(self):
       self.texture = 'stone.png'
       #print("stone")

   def set_texture_brick(self):
       self.texture = 'brick90.png'
       #print("brock90")

   def set_texture_blockglass(self):
       self.texture = 'block_glass.png'
       #print("brock90")
   def set_texture_green(self):
       self.texture = 'green.png'
       #print("brock90")
